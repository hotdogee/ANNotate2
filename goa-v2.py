...
def input_fn(mode, params, config):
    ...
    parse_fn = parse_example_go_v1
    if params.data_version == 'v2':
        parse_fn = parse_example_go_v2
    dataset = dataset.map(
...
def main(unused_args):
    ...
    if not FLAGS.num_classes or FLAGS.num_classes < 1:
        FLAGS.num_classes = FLAGS.metadata['go_total']
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='v2',
        help=
        'Data format version of training and evaluation data. v1 is for multi-label models, v2 is for seq2seq models'
    )
    parser.add_argument(
        '--metadata_path',
        type=str,
