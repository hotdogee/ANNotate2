...
def msgpack_to_tsv(path, min_region_length=5):
    ...
    return [
        r
        for r in regions if (r['end'] - r['start']) >= (min_region_length - 1)
    ]
...
if __name__ =='__main__':
    ...
    ) as e, output_path.open(mode='wt', newline='') as f:
        future_path = {e.submit(msgpack_to_tsv, p): p for p in in_paths}
...
# SCRIPTPATH=/home/hotdogee/Dropbox/Work/Btools/ANNotate/ANNotate2/util/pfam/annotate_pfam_batch_msgpack_to_tsv.py
# WORKERS=1
# VERSION=1567787595
# ${PYTHON} ${SCRIPTPATH} --indir /home/hotdogee/pfam/p31_seqs_with_p32_regions_of_p31_domains_fa_split_batched/pfam31_${VERSION}_results_raw --meta /home/hotdogee/pfam/pfam-regions-d0-s0-meta.json --output /home/hotdogee/pfam/p31_seqs_with_p32_regions_of_p31_domains.ann31_${VERSION}_results_v1_test1.tsv --workers ${WORKERS}
