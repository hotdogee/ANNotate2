...
/home/hotdogee/build/tb-hotdogee/bazel-bin/tensorboard/tensorboard --logdir /data12/checkpoints/pfam-regions-d0-s0/v4-BiRnn --port 6007 --samples_per_plugin=scalars=10000
